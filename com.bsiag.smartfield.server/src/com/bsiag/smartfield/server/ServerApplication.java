 ...
 ******************************************************************************/
package com.bsiag.smartfield.server;
 ...
 * org.eclipse.equinox.http.jetty.context.path=/smartfield
 ...
 * eclipse.product=com.bsiag.smartfield.server.product
 */
public class ServerApplication implements IApplication{
  ...
  public Object start(IApplicationContext context) throws Exception {
    ...
    */
    logger.info("smartfield server initialized");
    return EXIT_OK;
  }
